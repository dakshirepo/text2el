...
if __name__ == '__main__':
    apply_regex_rules("text2el\data\extracted_notes_MIMIC-III_Evaluation", "extracted_events.csv")
    extract_specific_notes("text2el\data\extracted_notes_MIMIC-III_Evaluation", "specific_events.csv")
