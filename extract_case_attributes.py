...
def extract_case_attributes(dependenc_csv, extracted_case_csv, all_case_att_csv,all_events_csv):
    ...
    exclude_l=['birth:  [', 'birth:  [' ,'admit' , 'discharge', 'Discharge Date', 'Date of Birth', 'birth:  [']
    exclude_v = ['+2  Left:+2']            
...
if __name__ == '__main__':
    ...
    extract_case_attributes("/mnt/c/Research/MIMIC_Exp/Test/case_dep.csv", "/mnt/c/Research/MIMIC_Exp/Test/attributes_newww.csv", "/mnt/c/Research/MIMIC_Exp/Test/case_attr_final.csv",'/mnt/c/Research/MIMIC_Exp/Test/all_events.csv')
